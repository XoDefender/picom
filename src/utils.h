...
static inline struct color int_hex_to_rgb(int hex) {
	struct color rgb;
	rgb.red = normalize_d((float)(hex >> 16) / 256);
	rgb.green = normalize_d((float)((hex & 0x00ff00) >> 8) / 256);
	rgb.blue = normalize_d((float)(hex & 0x0000ff) / 256);
